...
public class DbTaskContactRecord extends UpdatableRecordImpl<DbTaskContactRecord> implements Record3<Integer, Integer, Integer> {
    ...
    @Override
    public DbTaskContactRecord value1(Integer value) {
        setId(value);
        return this;
    }

    @Override
    public DbTaskContactRecord value2(Integer value) {
        setTask(value);
        return this;
    }

    @Override
    public DbTaskContactRecord value3(Integer value) {
        setContact(value);
        return this;
    }

    @Override
    public DbTaskContactRecord values(Integer value1, Integer value2, Integer value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public DbTaskContactRecord(Integer id, Integer task, Integer contact) {
        super(DbTaskContact.DB_TASK_CONTACT);
