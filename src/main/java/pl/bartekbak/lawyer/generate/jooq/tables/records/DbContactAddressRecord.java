...
public class DbContactAddressRecord extends UpdatableRecordImpl<DbContactAddressRecord> implements Record3<Integer, Integer, Integer> {
    ...
    @Override
    public DbContactAddressRecord values(Integer value1, Integer value2, Integer value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public DbContactAddressRecord(Integer id, Integer address, Integer contact) {
        super(DbContactAddress.DB_CONTACT_ADDRESS);
