...
public class DbCourtRecord extends UpdatableRecordImpl<DbCourtRecord> implements Record4<Integer, String, String, String> {
    ...
    @Override
    public DbCourtRecord values(Integer value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DbCourtRecord(Integer courtId, String name, String description, String phone) {
        super(DbCourt.DB_COURT);
