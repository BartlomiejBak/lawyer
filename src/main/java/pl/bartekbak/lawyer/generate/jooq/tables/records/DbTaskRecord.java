...
public class DbTaskRecord extends UpdatableRecordImpl<DbTaskRecord> implements Record4<UUID, Boolean, LocalDateTime, String> {
    ...
    @Override
    public Row4<UUID, Boolean, LocalDateTime, String> valuesRow() {
    ...
    @Override
    public DbTaskRecord value1(UUID value) {
        setTaskId(value);
        return this;
    }
    ...
    @Override
    public DbTaskRecord values(UUID value1, Boolean value2, LocalDateTime value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DbTaskRecord(UUID taskId, Boolean priority, LocalDateTime deadline, String description) {
        super(DbTask.DB_TASK);
