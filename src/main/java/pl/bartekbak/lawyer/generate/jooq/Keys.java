...
public class Keys {
    ...
    public static final ForeignKey<DbContactRecord, DbAddressRecord> DB_CONTACT__CONTACT_ADDRESS_FKEY = Internal.createForeignKey(DbContact.DB_CONTACT, DSL.name("contact_address_fkey"), new TableField[] { DbContact.DB_CONTACT.ADDRESS }, Keys.ADDRESS_PKEY, new TableField[] { DbAddress.DB_ADDRESS.ADDRESS_ID }, true);
    public static final ForeignKey<DbContactRecord, DbAddressRecord> DB_CONTACT__CONTACT_SECONDARY_ADDRESS_FKEY = Internal.createForeignKey(DbContact.DB_CONTACT, DSL.name("contact_secondary_address_fkey"), new TableField[] { DbContact.DB_CONTACT.SECONDARY_ADDRESS }, Keys.ADDRESS_PKEY, new TableField[] { DbAddress.DB_ADDRESS.ADDRESS_ID }, true);
