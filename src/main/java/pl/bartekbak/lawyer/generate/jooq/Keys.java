...
public class Keys {
    ...
    public static final UniqueKey<DbContactRecord> UNIQUE_CONTACT = Internal.createUniqueKey(DbContact.DB_CONTACT, DSL.name("unique_contact"), new TableField[] { DbContact.DB_CONTACT.NAME }, true);
    ...
    public static final ForeignKey<DbCourtAddressRecord, DbCourtRecord> DB_COURT_ADDRESS__COURT_ADDRESS_COURT_FKEY = Internal.createForeignKey(DbCourtAddress.DB_COURT_ADDRESS, DSL.name("court_address_court_fkey"), new TableField[] { DbCourtAddress.DB_COURT_ADDRESS.COURT }, Keys.COURT_PKEY, new TableField[] { DbCourt.DB_COURT.COURT_ID }, true);
