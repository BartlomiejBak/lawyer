...
public class Keys {
    ...
    public static final ForeignKey<DbCourtAddressRecord, DbCourtRecord> DB_COURT_ADDRESS__COURT_ADDRESS_CONTACT_FKEY = Internal.createForeignKey(DbCourtAddress.DB_COURT_ADDRESS, DSL.name("court_address_contact_fkey"), new TableField[] { DbCourtAddress.DB_COURT_ADDRESS.COURT }, Keys.COURT_PKEY, new TableField[] { DbCourt.DB_COURT.COURT_ID }, true);
